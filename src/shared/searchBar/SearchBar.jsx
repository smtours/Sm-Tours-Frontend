    ...
    <div>
      <div className="search-bar">
        <form className="form md:flex hidden items-center gap-4">
          ...
          <span
            className="search-icon bg-BaseColor  w-14 rounded-lg cursor-pointer py-2 px-2 h-11 flex justify-center
             align-middle"
            type="submit"
          ...
          >
            ...
            {isLoading ? (
                  ...
                  <Loader type="ping-cube" bgColor={"white"} color={"white"}  size={30}/>
