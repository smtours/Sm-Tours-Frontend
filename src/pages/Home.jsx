...
import card01 from "../assets/images/road.jpg";
import card02 from "../assets/images/girl.jpg";
import card03 from "../assets/images/moun.jpg";
...
import faqImg from "../assets/images/chacha.png";
    ...
    <>
          ...
          <div>
            <div className="my-8">
              <h1 className="text-[33px] font-cursiveFont text-center md:text-[40px] md:text-start font-bold mb-4 ">
                ...
                <span className="text-BaseColor text-[40px] ">
                  SM TOURS AND TRAVELS
                </span>
              </h1>
              <p className="text-lg leading-8 text-gray-800 hidden md:block">
              Welcome to SM Tours and Travels, your gateway to exploring the breathtaking beauty of Pakistan's Northern Areas!As a passionate and experienced travel enthusiast, I founded SM Tours and Travels with a mission to share the natural wonders of our country with fellow travelers. With years of expertise in curating personalized tours, I ensure that every journey is a memorable and affordable experience.
              </p>

              <p className="mobpara md:hidden ">
              Welcome to SM Tours and Travels, your gateway to exploring the breathtaking beauty of Pakistan's Northern Areas!As a passionate and experienced travel enthusiast, I founded SM Tours and Travels with a mission to share the natural wonders of our country with fellow travelers.
              </p>
            </div>
          </div>
      ...
      <section className="pb-12 px-6 md:px-12">
        <div className="container mx-auto mt-8 flex-col flex md:flex-row">
          <div className="mb-6 flex-shrink-0 mx-4 flex-1 min-w-[30%]">
            ...
            Our agency specializes in organizing trips to the stunning destinations of Pakistan's North, including Hunza, Skardu, Naran, and more. We take pride in providing:
            </p>
      ...
      <section className="py-8 text-center px-6 md:px-12">
        ...
        <p className="text-lg leading-8 mb-8 text-gray-800">
          "Unveil travel wonders in our gallery, a snapshot of SM TOURS AND TRAVELS
          Trips."
        </p>
        <ImagesGallery />
      </section>
        ...
        <div className="py-8 px-6 md:px-12">
          <div className="mx-auto text-center xl:w-[470px]">
            ...
            <p className="text-lg font-paraFont font-bold leading-8 mb-8 text-gray-800">
              "Read what our customers have to say in their own words. Real
